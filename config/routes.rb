...
#               business_option_group_options POST   /businesses/:business_id/option_groups/:option_group_id/options(.:format)                         options#create
...
#                business_option_group_option PATCH  /businesses/:business_id/option_groups/:option_group_id/options/:id(.:format)                     options#update
...
#          business_property_group_properties POST   /businesses/:business_id/property_groups/:property_group_id/properties(.:format)                  properties#create
...
#            business_property_group_property PATCH  /businesses/:business_id/property_groups/:property_group_id/properties/:id(.:format)              properties#update
...
#    business_product_product_property_groups POST   /businesses/:business_id/products/:product_id/product_property_groups(.:format)                   product_property_groups#create
# new_business_product_product_property_group GET    /businesses/:business_id/products/:product_id/product_property_groups/new(.:format)               product_property_groups#new
#     business_product_product_property_group DELETE /businesses/:business_id/products/:product_id/product_property_groups/:id(.:format)               product_property_groups#destroy
#                   business_product_variants POST   /businesses/:business_id/products/:product_id/variants(.:format)                                  variants#create
...
#                    business_product_variant PATCH  /businesses/:business_id/products/:product_id/variants/:id(.:format)                              variants#update
