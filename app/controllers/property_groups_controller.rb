class PropertyGroupsController < ApplicationController
  ...
  # GET /products/:product_id/property_groups/new
  def new
    @property_group = @product.property_groups.build
  end

  # GET /products/:product_id/property_groups/:id/edit
  def edit
  end

  # POST /products/:product_id/property_groups
  def create
  ...
  # PATCH/PUT /products/:product_id/property_groups/:id
  def update
    respond_to do |format|
      if @property_group.update(property_group_params)
        format.turbo_stream { flash.now[:notice] = "Property group was successfully updated." }
      else
  ...
  # DELETE /products/:product_id/property_groups/:id
  def destroy
    respond_to do |format|
